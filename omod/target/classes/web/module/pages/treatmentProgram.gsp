...
<script>
    function handlePatientRowSelection() {
        this.handle = function (row) {
            window.location = ui.pageLink("treatmentapp", "main", { "patientId" : row.patientId, "queueId" : row.id })
        }
    }
    ...
    var getPatientsFromQueue = function(){
        ...
        jq.getJSON(ui.fragmentActionLink("patientqueueapp", "patientQueue", "getPatientsInProgramQueue"),
                {
                    'programConceptId': ${programConceptId}
                })
    ...
    var opdQueueLabel = "&nbsp; Treatment Queue &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;";
    ...
    <div class="patient-header new-patient-header">
        <div class="demographics">
            <h1 class="name" style="border-bottom: 1px solid #ddd;">
                <span class="page-label">TREATMENT QUEUE &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>
            </h1>
        </div>
